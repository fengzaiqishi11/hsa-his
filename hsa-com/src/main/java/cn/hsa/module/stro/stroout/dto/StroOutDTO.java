...
import cn.hsa.module.stro.stroout.entity.StroOutDO;
...
public class StroOutDTO extends StroOutDO implements Serializable {
   ...
   private List<StroOutDetailDTO> stroOutDetailDTOS;    //出库明细信息列表
