 ...
 **/
@Data
public class XzFmiOwnpayPatnMdtrtDDTO {
    ...
    /**
     * 妊娠时间	日期时间型				yyyy-MM-dd
     */
    private String preyTime;
    /**
     * 计划生育手术或生育日期	日期时间型				yyyy-MM-dd
     */
    private String birctrlOrMatnDate;
    /**
     * 伴有并发症标志	字符型
     */
     ...
     * 电子票据校验码	字符型	6
     */
    private String elecBillnoChkcode;
