package cn.hsa.insure.xiangtan.outpt;
...
/**
 * @Package_name: cn.hsa.insure.xiangtan.outpt
...
public class OutptFunction {
     ...
     * @Return java.util.Map<java.lang.String,java.lang.Object>
     */
    public Map<String,Object> bizh110003 (Map map) {
        InsureOutptOutFeeDTO insureOutptOutFeeDTO = (InsureOutptOutFeeDTO) map.get("insureOutptOutFeeDTO");
