...
//  }
    ...
    @PostMapping("/getHospCodeRSA")
    public String getHospCodeRSA(String hospCode){
        String publickey ="MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAImeWoemAQT+RVoYCV2Zwkp/Wd8tZJdLekP8fUMzXnAKIiveAjM9vIBFkozx6FflCTzUuRIWhytyq0Lf25+XGPECAwEAAQ==";
        String privatekey ="";

        try {
            String s = RSAUtil.encryptByPublicKey(hospCode.getBytes(), publickey);
            String o = RSAUtil.decryptByPrivateKey(Base64.decodeBase64(s.getBytes()), privatekey);
            return s;
        } catch (Exception e) {
            e.printStackTrace();
        }
