...
public class UnifiedCommon {
     ...
     * @Return
     **/
     public  Map<String, Object> commonInsureUnified(String hospCode, String regCode, String functionCode, Map<String, Object> paramMap) {
