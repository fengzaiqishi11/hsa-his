 ...
 * @Deacription 就医特殊属性查询-2407
 * @Author yuelong.chen
 * @Date 2022/5/16 10:33
 * @Version 1.0
 **/
@Service("newInsure" + Constant.UnifiedPay.REGISTER.UP_2407)
public class specialAttributeReqQueryUtil<T> extends InsureCommonUtil implements BaseReqUtil<T> {
    @Override
    public InsureInterfaceParamDTO initRequest(T param) {
        ...
        resultMap.put("infno",Constant.UnifiedPay.REGISTER.UP_2407);
