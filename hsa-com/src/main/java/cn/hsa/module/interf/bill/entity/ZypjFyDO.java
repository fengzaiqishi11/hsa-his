...
/**
 * 住院票据费用对象（与门诊票据费用数据对象的属性一致，可考虑两者共用一个对象）
 * @author liudawen
 * @date 2021/11/9
 */
@Data
...
public class ZypjFyDO extends PageDO implements Serializable {

    private static final long serialVersionUID = 7945501564917353098L;
    /**
     * 主键
     */
    private String id;
