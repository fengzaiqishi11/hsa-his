package cn.hsa.module.inpt.careTemplate.bo;
...
public interface InptNurseTemplateBO {
     ...
     * @Return pageDTO 分页对象
     **/
    PageDTO queryPage(InptNurseTemplateDTO inptNurseTemplateDTO);
     ...
     * @Return boolean
     **/
    boolean addInptNurseTemplate(InptNurseTemplateDTO inptNurseTemplateDTO);
     ...
     * @Return boolean
     **/
    boolean updateInptNurseTemplate(InptNurseTemplateDTO inptNurseTemplateDTO);
     ...
     * @Return boolean
     **/
    boolean updateIsValidInptNurseTemplate(InptNurseTemplateDTO inptNurseTemplateDTO);
