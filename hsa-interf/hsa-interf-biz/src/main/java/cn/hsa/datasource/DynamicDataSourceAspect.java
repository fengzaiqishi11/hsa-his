...
// * @Class_name: DynamicDataSourceAspect
// * @Description: 动态数据源切面
// * @Author: zhongming
...
//     * @Return
//     **/
//    @Pointcut("execution(* cn.hsa.*.*.service.impl..*.*(..))")
//    public void boPointcut() {
//    }
//
//    /**
//     * @Method 环绕增强
...
//
//            // 医院编码参数
//            String hospCode = MapUtils.get((Map)objs[0], "hospCode");
//            if (StringUtils.isEmpty(hospCode)) {
//                throw new AppException("无医院编码参数");
//            }
//
//            // 校验是否配置数据源
//            if (!DynamicRoutingDataSource.isExist(hospCode)) {
//                this.rateLoadDataSource(hospCode);
//                if (!DynamicRoutingDataSource.isExist(hospCode)){
//                    throw new AppException("未查询到医院编码【" + hospCode + "】对应数据源");
//                }
//            }
//
//            // 设置当前线程动态数据源
//            DynamicDataSourceContextHolder.setDataSourceKey(hospCode);
...
//     * @Return
//     **/
//    private void initDynamicDataSource(DynamicRoutingDataSource dynamicRoutingDataSource, String hospCode) throws Exception {
//        // 获取最新中心平台数据源集合
//        WrapperResponse<List<CenterDatasourceDTO>> wr = this.centerDatasourceService_consumer.getCenterHospitalDatasource(hospCode);
//
//        if (wr.getCode() != 0) {
...
//     * @Return
//     **/
//    public void rateLoadDataSource(String hospCode) {
//        try {
//            this.initDynamicDataSource((DynamicRoutingDataSource) SpringUtils.getBean("dataSource"), hospCode);
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }
//    }
