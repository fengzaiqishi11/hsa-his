 ...
 * @Class_name: InsureOutptSettleRemoveSetlinfoDO
 * @Describe: 统一支付平台-门诊结算撤销-输出-结算信息（节点标识：setlinfo）
 * @Author: luoyong
 * @Eamil: luoyong@powersi.com.cn
 * @Date: 2021-02-09 14:21
...
public class InsureOutptSettleRemoveSetlinfoDO implements Serializable {
    private static final long serialVersionUID = 1874804562756060124L;
    ...
    private BigDecimal oth_pay; //其他支出
    ...
    private BigDecimal pdnCashPay; //个人现金支出
    ...
    private BigDecimal medSumfee; //医保认可费用总额
