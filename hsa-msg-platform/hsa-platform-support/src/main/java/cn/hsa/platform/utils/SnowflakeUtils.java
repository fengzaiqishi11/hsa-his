 ...
 * @Class_name: SnowflakeUtils
 * @Description: 分布式ID生成工具（雪花算法）
 * @Author: zhongming
...
public class SnowflakeUtils {
    ...
    private static volatile SnowflakeUtils snowflake = null;
     ...
     * @return
     */
    public static SnowflakeUtils getInstanceSnowflake() {
        if (snowflake == null) {
            synchronized (lock) {
                long workerId ;
