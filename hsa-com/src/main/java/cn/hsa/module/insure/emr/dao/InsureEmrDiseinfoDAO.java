...
public interface InsureEmrDiseinfoDAO {
     ...
     * @Return int
     **/
    List<InsureEmrDiseinfoDTO> queryByMdtrtSn(@Param("mdtrtSn")String mdtrtSn, @Param("mdtrtId")String mdtrtId);
     ...
     * @Return int
     **/
    InsureEmrDiseinfoDTO queryByUuid(Long uuid);

    void deleteByMap(Map<String, Object> map);

    void insertList(List<InsureEmrDiseinfoDTO> insureEmrDiseinfoDTO);
}
