 ...
 * @Description: 电子病历自动归档业务
 * @Author: liuliyun
 * @Email: liyun.liu@powersi.com
 * @Date:2021/06/25 10:39
 * @Company: 创智和宇
 **/
@com.xxl.job.core.handler.annotation.JobHandler(value="emrAutoArchivingJob")
@Component
public class EmrAutoArchivingJobHandler extends IJobHandler {
    ...
    public ReturnT<String> execute(String params) throws Exception {
        ...
        for(CenterHospitalDTO centerHospitalDTO : centerHospitalDTOList){
            ...
            WrapperResponse<Boolean> wr=emrArchiveLoggingService_consumer.outHospInsertEmrArchiveLogging(map);
            XxlJobLogger.log("医院编号【" + centerHospitalDTO.getCode() + "】， 医院名称【" + centerHospitalDTO.getName() + "】电子病历自动归档信息：" + wr.getMessage());
        }
        return SUCCESS;
    }
    ...
    private List<CenterHospitalDTO> queryValidCenterHospital() {
        ...
        if (wr.getCode() != 0) {
            XxlJobLogger.log("电子病历自动归档定时任务执行失败：" + wr.getMessage());
        }
