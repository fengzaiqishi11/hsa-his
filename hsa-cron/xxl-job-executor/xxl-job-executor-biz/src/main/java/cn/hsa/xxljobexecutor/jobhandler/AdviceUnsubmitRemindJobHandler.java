 ...
 * @Description: 医嘱未提交提醒定时器
 * @Author: liuliyun
 * @Email: liyun.liu@powersi.com
 * @Date:2021/12/06 15:43
 * @Company: 创智和宇
 **/
@com.xxl.job.core.handler.annotation.JobHandler(value="adviceUnsubmitRemindJob")
@Component
public class AdviceUnsubmitRemindJobHandler extends IJobHandler {
    ...
    public ReturnT<String> execute(String params) throws Exception {
        ...
        for(CenterHospitalDTO centerHospitalDTO : centerHospitalDTOList){
            ...
            map.put("crteId","-1");
            WrapperResponse<Boolean> wr=doctorAdviceService_consumer.queryUnsubmitAdviceList(map);
            XxlJobLogger.log("医院编号【" + centerHospitalDTO.getCode() + "】， 医院名称【" + centerHospitalDTO.getName() + "】医嘱未提交提醒信息：" + wr.getMessage());
        }
        return SUCCESS;
    }
    ...
    private List<CenterHospitalDTO> queryValidCenterHospital() {
        ...
        if (wr.getCode() != 0) {
            XxlJobLogger.log("医嘱未提交提醒定时任务执行失败：" + wr.getMessage());
        }
