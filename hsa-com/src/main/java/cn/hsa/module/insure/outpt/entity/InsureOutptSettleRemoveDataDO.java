 ...
 * @Class_name: InsureOutptSettleRemoveDataDO
 * @Describe: 统一支付平台-门诊结算撤销-数据输入（节点标识：data）
 * @Author: luoyong
 * @Eamil: luoyong@powersi.com.cn
 * @Date: 2021-02-09 14:05
...
public class InsureOutptSettleRemoveDataDO implements Serializable {
    private static final long serialVersionUID = -7850226375501775882L;
