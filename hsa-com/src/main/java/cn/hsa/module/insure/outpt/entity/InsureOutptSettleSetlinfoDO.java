 ...
 * @ClassName: InsureOutptSettleSetlinfoDO
 * @Describe: 统一支付平台-门诊结算-输出-结算信息（节点标识：setlinfo）
 * @Author: luoyong
...
public class InsureOutptSettleSetlinfoDO implements Serializable {
    private static final long serialVersionUID = -8691220858249870118L;
