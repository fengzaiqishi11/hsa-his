package cn.hsa.module.sync.synccode.service;
...
public interface SyncCodeService {
     ...
     **/
    @GetMapping("/service/sync/code/getByCode")
    WrapperResponse<Map<String, List<SyncCodeSelectDTO>>> getByCode(Map map);
     ...
     **/
    @GetMapping("/service/sync/code/queryCodePage")
     ...
     * @Return: cn.hsa.hsaf.core.framework.web.WrapperResponse<cn.hsa.base.PageDTO>
     **/
    @GetMapping("/service/sync/code/queryCodeDetailPage")
     ...
     **/
    @GetMapping("/service/sync/code/getCodeById")
    WrapperResponse<SyncCodeDTO> getCodeById(Map map);
     ...
     * @Return: cn.hsa.hsaf.core.framework.web.WrapperResponse<cn.hsa.module.base.synccode.dto.SyncCodeDTO>
     **/
    @GetMapping("/service/sync/code/getCodeDetailById")
    WrapperResponse<SyncCodeDetailDTO> getCodeDetailById(Map map);
    ...
    * @Author jiahong.yang
    * @Date   2020/9/1 10:18
    * @Return cn.hsa.hsaf.core.framework.web.WrapperResponse<cn.hsa.module.sync.synccode.dto.SyncCodeDetailDTO>
    **/
    @GetMapping("/service/sync/code/getMaxSeqno")
     ...
     **/
    @PostMapping("/service/sync/code/saveCode")
     ...
     * @Return: cn.hsa.hsaf.core.framework.web.WrapperResponse<java.lang.Boolean>
     **/
    @PostMapping("/service/sync/code/saveCodeDetail")
     ...
     * @Return: cn.hsa.hsaf.core.framework.web.WrapperResponse<java.lang.Boolean>
     **/
    @PostMapping("/service/sync/code/deleteCodes")
     ...
     * @Return: cn.hsa.hsaf.core.framework.web.WrapperResponse<java.lang.Boolean>
     **/
    @PostMapping("/service/sync/code/deleteCodeDetails")
     ...
     *
     * @return*/
    @GetMapping("/service/sync/code/getCodeTree")
