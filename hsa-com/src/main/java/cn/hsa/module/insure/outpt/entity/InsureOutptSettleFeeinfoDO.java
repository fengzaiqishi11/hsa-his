 ...
 * @Class_name: InsureOutptSettleFeeinfoDO
 * @Describe: 统一支付平台-门诊结算-数据集输入（节点标识：feeinfo）
 * @Author: luoyong
 * @Eamil: luoyong@powersi.com.cn
 * @Date: 2021-02-09 16:57
...
public class InsureOutptSettleFeeinfoDO implements Serializable {
    private static final long serialVersionUID = 6185074123856962666L;
    ...
    private String sinDosDscr; //计量单位
