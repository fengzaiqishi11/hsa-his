...
public class ReflectionUtils {
    ...
    public static <T> T getFieldValue(final Object obj, final String fieldName) {
        ...
        if (field == null) {
            throw new RuntimeException("Could not find field [" + fieldName + "] on target [" + obj + "]");
        }
    ...
    public static Object invokeMethod(final Object obj, final String methodName, final Class<?>[] parameterTypes, final Object[] args) {
        ...
        if (method == null) {
            throw new RuntimeException("Could not find method [" + methodName + "] on target [" + obj + "]");
        }
