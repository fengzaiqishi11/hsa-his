...
public class OutptPaymentController extends BaseController {
    ...
    public WrapperResponse<Boolean> checkOutptPhonePayAuthority(HttpServletRequest req, HttpServletResponse res) {
        SysUserDTO sysUserDTO = getSession(req, res);
        String systemCode = sysUserDTO.getSystemCode();
        Map param =new HashMap();
        param.put("hospCode",sysUserDTO.getHospCode());
        return WrapperResponse.success(outptPaymentService_consumer.checkOutptPhonePayAuthority(param));
    }
