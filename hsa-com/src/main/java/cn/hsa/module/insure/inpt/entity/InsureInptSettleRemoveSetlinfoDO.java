 ...
 * @Class_name: InsureInptSettleRemoveSetlinfoDO
 * @Describe: 统一支付平台-住院结算撤销-输出-结算信息（节点标识：setlinfo）
 * @Author: luoyong
 * @Eamil: luoyong@powersi.com.cn
 * @Date: 2021-02-09 15:03
...
public class InsureInptSettleRemoveSetlinfoDO implements Serializable {
    private static final long serialVersionUID = -4200688279511979709L;
    ...
    private BigDecimal actPayPedc; //实际支付起付线
