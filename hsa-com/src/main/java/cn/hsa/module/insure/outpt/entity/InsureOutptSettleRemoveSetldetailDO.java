 ...
 * @Class_name: InsureOutptSettleRemoveSetldetailDO
 * @Describe: 统一支付平台-门诊结算撤销-输出-结算基金分项信息（节点标识：setldetail）
 * @Author: luoyong
 * @Eamil: luoyong@powersi.com.cn
 * @Date: 2021-02-09 14:43
...
public class InsureOutptSettleRemoveSetldetailDO implements Serializable {
    private static final long serialVersionUID = 5609177039759857664L;
