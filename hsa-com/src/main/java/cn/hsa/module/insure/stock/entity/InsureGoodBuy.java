...
public class InsureGoodBuy  extends PageDO implements Serializable {
    ...
    private String dyntNo	;// 随货单号	字符型	50	　	　	新医保/核三	核三：aae072
    ...
    private String prodentpName	;// 生产厂家名称	字符型	200	　	Y　	新医保
    private String aprvno	;// 批准文号	字符型	100	　	Y　	新医保
    ...
    private String purcInvoNo	;// 采购发票号	字符型	50	　	　	新医保
    private String rxFlag	;// 处方药标志	字符型	3	　	Y　	新医保
