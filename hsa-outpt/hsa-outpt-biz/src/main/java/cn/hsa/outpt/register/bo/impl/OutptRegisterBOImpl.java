...
public class OutptRegisterBOImpl extends HsafBO implements OutptRegisterBO {
    ...
    public Map<String, String> saveOutRegisterSettle(Map map) {
        ...
        if (SFJS){
            // 处理挂号结算数据
            settleId = disposeGhjs(outptRegisterSettleDto, ghid, jzid, hospCode, docId, docName, sysdate);
            // 门诊划价处再收费 则插入数据进费用表
        } else {
...
//        }
    ...
    private String disposeGhjs(OutptRegisterSettleDto outptRegisterSettleDto, String registerId, String visitId, String hospCode, String docId, String docName, Date sysdate) {
...
//            outptRegisterSettleDto.setRealityPrice(xjzf);
    ...
    private void disposeTriageVisit(OutptVisitDTO outptVisitDTO, OutptRegisterDTO outptRegisterDTO, String ghid, String ghdh, String jzid, String hospCode) {
        ...
        outptTriageVisitDTO.setSortNo(getSequenceNoByCond(outptRegisterDTO.getDeptId(),null,hospCode));
